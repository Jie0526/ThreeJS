...
function init(){
    ...
    audioLoader.load('assets/cola_open_can_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/cola_can_switch_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/cola_can_recycle.mp3', function (buffer) { 
    ...
    audioLoader.load('assets/put_down_cola_can_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/roll_cola_can_sound.mp3', function (buffer) {
    ...
    function loadModel(modelPath){
        ...
        loader.load(modelPath, function (gltf){
            ...
            // Second model
            if (modelPath === 'assets/cola_can_switch.glb') {
            ...
            // Third model
            if (modelPath === 'assets/cola_can_recycle.glb') {
            ...
            // Pull down moedl
            if (modelPath === 'assets/put_down_cola_can.glb') {
            ...
            // row model
            // Put Down 模型
            if (modelPath === 'assets/roll_cola_can.glb') {
