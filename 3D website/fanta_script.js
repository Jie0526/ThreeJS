...
function init(){
    ...
    audioLoader.load('assets/fanta_open_can_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/fanta_can_switch_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/fanta_can_recycle_sound.mp3', function (buffer) { 
    ...
    audioLoader.load('assets/put_down_fanta_can_sound.mp3', function (buffer) {
    ...
    audioLoader.load('assets/roll_fanta_can_sound.mp3', function (buffer) {
    ...
    function loadModel(modelPath){
        ...
        loader.load(modelPath, function (gltf){
            ...
            // Second model
            if (modelPath === 'assets/fanta_can_switch.glb') {
            ...
            // Third model
            if (modelPath === 'assets/fanta_can_recycle.glb') {
            ...
            // Pull down moedl
            if (modelPath === 'assets/put_down_fanta_can.glb') {
